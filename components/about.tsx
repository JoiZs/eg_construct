...
export const About = (props: Props) => {
    return (
        <section id='sectAbout' className='h-screen w-full sectscroll px-12 py-8 flex flex-col md:flex-row justify-between items-center dark:text-white'>
            <div className='md:flex-1 w-full h-1/2 md:h-full p-10 overflow-hidden relative'>
                <div className='absolute z-10'>
                    <h1 id='textTitle1' className='text-5xl uppercase tracking-wider'>Title</h1>
            ...
            <div className='md:flex-1 w-full h-3/4 border-t-2 grid grid-cols-2 grid-rows-2 gap-1 opacity-80'>
                    <div className='relative cursor-pointer overflow-hidden'>
                        ...
                        <img className='absolute h-full w-full' src="https://wallpaperaccess.com/full/1295663.jpg" alt="about" height={'100%'} /></div>
                    <div className='relative cursor-pointer overflow-hidden'>
                        <span className='absolute bg-gray-600 dark:bg-gray-300 text-white dark:text-black italic uppercase bottom-0 w-full z-10'>title</span>
                        <img className='absolute h-full w-full' src="https://wallpaperaccess.com/full/1295663.jpg" alt="about" height={'100%'} /></div>
                    <div className='col-span-2 cursor-pointer relative overflow-hidden'>
                        <span className='absolute bg-gray-600 dark:bg-gray-300 text-white dark:text-black italic uppercase bottom-0 w-full z-10'>title</span>
                        <img className='absolute h-full w-full' src="https://wallpaperaccess.com/full/1295663.jpg" alt="about" /></div>
            </div>
        </section>
    )
}
